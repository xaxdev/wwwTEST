...
module.exports = {
    ...
    handler: (request, reply) => {
        ...
        try {
            ...
            buckleTypes,strapTypes,strapColors,complications,hierarchy,accessoryTypes,sparePartTypes,articles,salechannels,customers`;
            ...
            Promise.all([alldata]).then(function([alldata]) {
                ...
                const customersTypesget = alldata.hits.hits.filter((element)=> {{
                    return element._type == 'customers';
                }})
                ...
                const responsesata = {
                    ...
                    gemstoneStoneType: _.sortBy(gemstoneStoneTypeget.map((element)=> element._source),'id'),
                    ...
                    customers: _.sortBy(customersTypesget.map((element)=> element._source),'accountNumber')
                };
                elastic.close();
