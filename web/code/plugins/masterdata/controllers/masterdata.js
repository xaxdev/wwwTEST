  ...
  handler: (request, reply) => {
    ...
    const alldata = elastic
      ...
      const responsesata = {
        ...
        colors: _.sortBy(colorsget.map((element)=> element._source),['priority', 'name'],['desc', 'asc']),
        colorGrades: _.sortBy(colorGradesget.map((element)=> element._source),'name'),
        clarities: _.sortBy(claritiesget.map((element)=> element._source),['priority', 'name'],['desc', 'asc']),
        ...
        collections: _.sortBy(collectionsget.map((element)=> element._source),['priority', 'name'],['desc', 'asc']),
        brands: _.sortBy(brandsget.map((element)=> element._source),['priority', 'name'],['desc', 'asc']),
