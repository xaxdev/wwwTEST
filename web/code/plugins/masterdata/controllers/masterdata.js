  ...
  handler: (request, reply) => {
    ...
    const alldata = elastic
      ...
      const responsesata = {
        ...
        cut: _.sortBy(cutget.map((element)=> element._source),'code'),
        cutGrades: _.sortBy(cutGradesget.map((element)=> element._source),'name'),
        colors: _.sortBy(colorsget.map((element)=> element._source),'code'),
        ...
        collections: _.sortBy(collectionsget.map((element)=> element._source),'code'),
        brands: _.sortBy(brandsget.map((element)=> element._source),'code'),
