  ...
  handler: (request, reply) => {
    ...
    const alldata = elastic
      ...
      const responsesata = {
        ...
        cut: _.sortBy(cutget.map((element)=> element._source),['priority', 'name']),
        cutGrades: _.sortBy(cutGradesget.map((element)=> element._source),'name'),
        colors: _.sortBy(colorsget.map((element)=> element._source),['priority', 'name']),
        colorGrades: _.sortBy(colorGradesget.map((element)=> element._source),'name'),
        clarities: _.sortBy(claritiesget.map((element)=> element._source),['priority', 'name']),
        ...
        collections: _.sortBy(collectionsget.map((element)=> element._source),['priority', 'name']),
        brands: _.sortBy(brandsget.map((element)=> element._source),['priority', 'name']),
