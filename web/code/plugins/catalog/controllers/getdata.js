    ...
    handler: (request, reply) => {
        ...
        (async () => {
            ...
            try {
                ...
                const user = await catalog.getUserById(request, reply, request.auth.credentials.id)
                ...
                db.collection('CatalogItem')
                .find({ "catalogId" : new ObjectID(request.params.id) }, { "itemId": 1 })
                .sort({ "updatedDate": -1 })
                .toArray()
                .then((data) => {
