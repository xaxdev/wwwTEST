    ...
    if (keys.length != 3 ){
        keys.forEach((key) => {
            ...
            if(key == 'reference' || key == 'stoneType' || key == 'cut' || key == 'cutGrade' || key == 'clarity' || key == 'polish' || key == 'symmetry'
                ...
                || key == 'color' || key == 'setReference' || key == 'warehouse' || key == 'article' || key == 'specialDiscountPercent'
            ){
                value = `${value}`
            ...
            if(key != 'page' && key != 'sortBy' && key != 'sortDirections' && key != 'userCurrency' && key != 'fields' && key != 'price' && key != 'pageSize'
                ...
                && key != 'watHierarchy' && key != 'stoHierarchy' && key != 'accHierarchy' && key != 'obaHierarchy' && key != 'sppHierarchy'  && key != 'itemsList'
            ){
                if(key == 'stoneType' || key == 'cut' || key == 'cutGrade' || key == 'clarity' || key == 'certificateAgency' || key == 'polish' || key == 'origin'
                    ...
                    || key == 'article' || key == 'accessoryType' || key == 'sparePartType'
                ){
                    if(key == 'metalColour')
                        key = 'metalColor'
                    if(key == 'location')
