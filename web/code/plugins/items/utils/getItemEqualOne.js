        ...
        ${item.items.map((subitem) => {
            return (
                    `<tr id=${subitem.reference} >
                        ...
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;">${item.reference}</td>
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;">${subitem.reference}</td>
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;">${subitem.description}</td>
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;">${subitem.sku}</td>
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;">${subitem.hierarchy != undefined ? subitem.hierarchy.split('\\').slice(-1).pop():''}</td>
                        ...
                        <td style="padding:5px 5px;word-break: normal;font-size: 6px; border: 1px solid #5c5954;${(userPermissionPrice == 'Public'
