        ...
        ${item.items.map((subitem) => {
            return (
                    `<tr id=${subitem.reference} >
                        <td style="padding:5px 5px;word-break: normal;font-size: 5px; border: 1px solid #5c5954;">
                            <img src="${imagesProduct}" width="60">
                        </td>
                        <td style="padding:5px 5px;word-break: normal;font-size: 5px; border: 1px solid #5c5954;">${item.reference}</td>
