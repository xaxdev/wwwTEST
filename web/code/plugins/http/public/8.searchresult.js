...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseCallback = __webpack_require__(835),
	    baseCompareAscending = __webpack_require__(844),
	    baseEach = __webpack_require__(845),
	    baseSortBy = __webpack_require__(846),
	    isIterateeCall = __webpack_require__(847);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var baseIsEqual = __webpack_require__(836),
	    bindCallback = __webpack_require__(842),
	    isArray = __webpack_require__(837),
	    pairs = __webpack_require__(843);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArray = __webpack_require__(837),
	    isTypedArray = __webpack_require__(838),
	    keys = __webpack_require__(839);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(840),
	    isArguments = __webpack_require__(841),
	    isArray = __webpack_require__(837);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _itemactions = __webpack_require__(1198);
	...
	var _griditemview = __webpack_require__(1201);

	var _griditemview2 = _interopRequireDefault(_griditemview);

	var _listitemview = __webpack_require__(1202);
	...
	var _ = __webpack_require__(1211);
	...
	var SearchResult = function (_Component) {
	  ...
	  function SearchResult(props) {
	    ...
	    _this.gridViewResults = _this.gridViewResults.bind(_this);
	    _this.listViewResults = _this.listViewResults.bind(_this);
	    _this.sortingBy = _this.sortingBy.bind(_this);
	    _this.sortingDirection = _this.sortingDirection.bind(_this);
	    _this.newSearch = _this.newSearch.bind(_this);
	    _this.exportExcel = _this.exportExcel.bind(_this);

	    _this.state = {
	      activePage: _this.props.currentPage,
	      showGridView: true,
	      showListView: false
	    };
	    return _this;
	  ...
	  _createClass(SearchResult, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.props.getItems(this.props.currentPage);
	    }
	  }, {
	    key: 'handleSelect',
	    value: function handleSelect(eventKey) {
	      ...
	      this.props.getItems(eventKey);
	      var currPage = this.props.fields.currPage;
	    ...
	    value: function handleGo(e) {
	      ...
	      this.props.getItems(getPage);
	    }
	  }, {
	    key: 'renderPagination',
	    value: function renderPagination() {
	      var _props = this.props;
	      var currPage = _props.fields.currPage;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', _extends({ type: 'text', placeholder: this.state.activePage, ref: 'reletego' }, currPage)),
	          _react2.default.createElement(
	            'span',
	            null,
	            'of'
	          ...
	          _react2.default.createElement(
	            'button',
	            { type: 'button', disabled: submitting, onClick: this.handleGo },
	            'Go'
	          )
	        )
	      );
	    ...
	    value: function renderTotals() {
	      var _props2 = this.props;
	      var currPage = _props2.fields.currPage;
	      var totalPages = _props2.totalPages;
	      var currentPage = _props2.currentPage;
	      var items = _props2.items;
	      var totalPublicPrice = _props2.totalPublicPrice;
	      var totalUpdatedCost = _props2.totalUpdatedCost;
	      var handleSubmit = _props2.handleSubmit;
	      var resetForm = _props2.resetForm;
	    ...
	    key: 'onClickGrid',
	    value: function onClickGrid(pageNumber) {
	    ...
	    key: 'gridViewResults',
	    value: function gridViewResults() {
	      this.setState({
	        showGridView: true,
	        showListView: false
	      });
	    ...
	    key: 'listViewResults',
	    value: function listViewResults() {
	      this.setState({
	        showGridView: false,
	        showListView: true
	      });
	    ...
	    key: 'sortingBy',
	    value: function sortingBy(e) {
	      var sortingBy = e.target.value;
	      var searchResult = this.props.searchResult;

	      var sortingDirection = this.refs.sortingDirection.value;

	      this.props.sortBy(searchResult, sortingBy, sortingDirection);
	    }
	  }, {
	    key: 'sortingDirection',
	    value: function sortingDirection(e) {
	      var sortingDirection = e.target.value;
	      var searchResult = this.props.searchResult;

	      var sortingBy = this.refs.sortingBy.value;
	    ...
	    value: function render() {
	      ...
	      var totalPublicPrice = _props3.totalPublicPrice;
	      var totalUpdatedCost = _props3.totalUpdatedCost;
	      var handleSubmit = _props3.handleSubmit;
	      var resetForm = _props3.resetForm;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-4 m-width-60 ft-white m-nopadding' },
	            _react2.default.createElement(
	              'h1',
	              null,
	              'SEARCH RESULTS'
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-8 m-width-40 nopadding' },
	            _react2.default.createElement(
	              'div',
	              { className: 'text-right maring-t15 float-r' },
	              _react2.default.createElement(
	                'div',
	                { className: 'col-sm-2 ft-white' },
	                _react2.default.createElement(
	                  _reactRouter.Link,
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _reactRouter.Link,
	                  { to: '/inventories?mod', className: 'btn btn-searchresult' },
	                  'Modify Search'
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                { className: 'col-sm-2 ft-white margin-t5' },
	                _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'select',
	                  { className: 'form-searchresult', onChange: this.sortingBy, ref: 'sortingBy' },
	                  _react2.default.createElement(
	                    'option',
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'col-sm-2 nopadding padding-l10' },
	                _react2.default.createElement(
	                  'select',
	                  { className: 'form-searchresult', onChange: this.sortingDirection, ref: 'sortingDirection' },
	                  _react2.default.createElement(
	                    'option',
	                    { key: 'desc', value: 'desc' },
	                    'Descending'
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'col-sm-2 ft-white nopadding' },
	                _react2.default.createElement(
	                  'div',
	                  {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'a',
	                      null,
	                      _react2.default.createElement('div', { className: 'icon-excel margin-l10', disabled: submitting,
	                        onClick: this.exportExcel })
	                    ),
	                    _react2.default.createElement(
	                      'a',
	                      null,
	                      _react2.default.createElement('div', { className: 'icon-print margin-l10' })
	                    )
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'col-sm-6 pagenavi' },
	                    _react2.default.createElement(
	                      'div',
	                      { className: 'searchresult-navi margin-r10' },
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'bg-or text-center' },
	                  this.renderTotals()
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'search-product ' + (this.state.showGridView ? '' : 'hidden') },
	                  _react2.default.createElement(_griditemview2.default, { items: items, onClickGrid: this.onClickGrid })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'col-sm-12 search-product ' + (this.state.showListView ? '' : 'hidden') },
	                  _react2.default.createElement(_listitemview2.default, { items: items, onClickGrid: this.onClickGrid })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'col-sm-12 pagenavi maring-t20' },
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'searchresult-navi pull-right margin-r20' },
	                    this.renderPagination()
	                  )
	                )
	              )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _itemconstants = __webpack_require__(1199);

	var _getUrlApiCurrPage = __webpack_require__(1200);

	var _getUrlApiCurrPage2 = _interopRequireDefault(_getUrlApiCurrPage);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function getItems(currPage) {
	  var token = sessionStorage.token;
	  var url = (0, _getUrlApiCurrPage2.default)(currPage);
	  // console.log('url-->',url);

	  return {
	    type: _itemconstants.FETCH_ALLITEMS,
	...
	function sortBy(data, sortBy, sortDirections) {
	  var token = sessionStorage.token;
	  return {
	    type: _itemconstants.FETCH_SORTING,
	    sortBy: sortBy,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FETCH_ALLITEMS = exports.FETCH_ALLITEMS = 'FETCH_ALLITEMS';
	var FETCH_ITEM = exports.FETCH_ITEM = 'FETCH_ITEM';
	var FETCH_SORTING = exports.FETCH_SORTING = 'FETCH_SORTING';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = getUrlApi;

	var _itemconstants = __webpack_require__(1199);

	function getUrlApi(currPage) {
	  var url = '';
	  switch (currPage) {
	    case 1:
	      return url = _itemconstants.ROOT_URL + 'products';
	    case 2:
	      return url = _itemconstants.ROOT_URL + 'products2';
	    case 3:
	      return url = _itemconstants.ROOT_URL + 'products3';
	    default:
	      return url = _itemconstants.ROOT_URL + 'products';
	  }
	  console.log('url-->', url);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridItemsView = function (_Component) {
	  _inherits(GridItemsView, _Component);

	  function GridItemsView(props) {
	    _classCallCheck(this, GridItemsView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GridItemsView).call(this, props));

	    _this.renderShowDetails = _this.renderShowDetails.bind(_this);
	    _this.onClickGrid = _this.onClickGrid.bind(_this);
	    _this.onMouseOverGrid = _this.onMouseOverGrid.bind(_this);
	    _this.onMouseOutGrid = _this.onMouseOutGrid.bind(_this);
	  ...
	  _createClass(GridItemsView, [{
	    ...
	    key: 'onClickGrid',
	    value: function onClickGrid(event) {
	    ...
	    key: 'onMouseOverGrid',
	    value: function onMouseOverGrid(e) {
	    ...
	    key: 'onMouseOutGrid',
	    value: function onMouseOutGrid(e) {
	    ...
	    key: 'renderShowDetails',
	    value: function renderShowDetails() {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.items.map(function (item, index) {
	          ...
	          return _react2.default.createElement(
	            'div',
	            { key: item.id, name: item.id, id: index,
	              className: 'col-md-3', onMouseOver: showDetails, onMouseOut: hideDetails },
	            _react2.default.createElement(
	              'div',
	              { className: 'over-product', name: item.id, id: item.id, onClick: btnEvent },
	              _react2.default.createElement(
	                'div',
	                { key: item.id, id: index, style: {
	                    display: index == 0 ? '' + (that.state.isOpen0 ? '' : 'none') : index == 1 ? '' + (that.state.isOpen1 ? '' : 'none') : index == 2 ? '' + (that.state.isOpen2 ? '' : 'none') : index == 3 ? '' + (that.state.isOpen3 ? '' : 'none') : index == 4 ? '' + (that.state.isOpen4 ? '' : 'none') : index == 5 ? '' + (that.state.isOpen5 ? '' : 'none') : index == 6 ? '' + (that.state.isOpen6 ? '' : 'none') : index == 7 ? '' + (that.state.isOpen7 ? '' : 'none') : ''
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'searchresult-prodcut' },
	              _react2.default.createElement(
	                'div',
	                { className: 'pull-right margin-r20' },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'grid-add',
	                    onClick: function onClick(eventKey) {
	                      console.log('eventKey-->', item.id);
	                    } },
	                  _react2.default.createElement('span', { className: 'icon-add-28' })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'checkbox checkbox-warning' },
	                  _react2.default.createElement('input', _defineProperty({ type: 'checkbox', id: 'checkbox1', className: 'styled' }, 'type', 'checkbox')),
	                  _react2.default.createElement('label', { 'for': 'checkbox1' })
	                )
	              ),
	              _react2.default.createElement('img', { src: item.gallery[0].original, responsive: true, width: 200, height: 200 }),
	              _react2.default.createElement(
	                'p',
	                { className: 'font-b' },
	                _react2.default.createElement(
	                  'span',
	                  { name: item.id, id: item.id, onClick: btnEvent },
	                  item.reference
	                ),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'product-detail-h' },
	                item.description
	              ),
	              _react2.default.createElement(
	                'span',
	                { className: 'fc-ae8f3b font-b price' },
	                item.updatedCostUSD,
	                ' ',
	                userLogin.currency
	              ),
	...
	GridItemsView.propTypes = {
	  onClickGrid: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListItemsView = function (_Component) {
	  _inherits(ListItemsView, _Component);

	  function ListItemsView(props) {
	    _classCallCheck(this, ListItemsView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ListItemsView).call(this, props));

	    _this.renderImage = function (val, row) {
	      return _react2.default.createElement('img', { src: row.imageThumbnail, width: '60', height: '60' });
	    };

	    _this.renderCheckItem = function (val, row) {
	      return _react2.default.createElement(
	        'div',
	        null,
	    ...
	    _this.renderCheckItem = _this.renderCheckItem.bind(_this);
	  ...
	  _createClass(ListItemsView, [{
	    key: 'renderAction',
	    value: function renderAction(val, row) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'searchresult-list-icon' },
	        _react2.default.createElement(
	          'button',
	          { type: 'button',
	            onClick: function onClick(eventKey) {
	          ...
	          _react2.default.createElement('img', { src: '/images/icon-add.png', width: '30' })
	        ),
	        _react2.default.createElement('br', null),
	        _react2.default.createElement(
	          'button',
	          { type: 'button', name: row.id, id: row.id, onClick: this.onClickGrid },
	          _react2.default.createElement('img', { src: '/images/icon-search-30.png', width: '30' })
	        )
	      );
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      if (this.props.items.length != 0) {
	        items = this.props.items.map(function (col, idx) {
	          return _extends({}, col, { imageOriginal: col.gallery[0].original, imageThumbnail: col.gallery[0].thumbnail });
	        });

	        // console.log('items-->',items);

	        var tableColumns = [{ title: '', render: this.renderCheckItem }, { title: 'Images', render: this.renderImage }, { title: 'Item Reference', prop: 'reference' }, { title: 'Description', prop: 'description' }, { title: 'SKU', prop: 'sku' }, { title: 'Location', prop: 'location' }, { title: 'Warehouse', prop: 'site' }, { title: 'Size', prop: 'size' }, { title: 'Case Dimension', prop: '' }, { title: 'OBA Dimension', prop: '' }, { title: 'Jewelry Weight', prop: '' }, { title: 'Gross Weight', prop: 'grossWeight' }, { title: 'Public Price', prop: 'priceUSD' }, { title: '', render: this.renderAction, className: 'text-center' }];
	        ...
	        items = _extends({}, this.props.items);
	        // console.log('items-->',items);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DataTable = __webpack_require__(1204);
	exports.Table = __webpack_require__(1205);
	exports.Pagination = __webpack_require__(1206);
	exports.SelectField = __webpack_require__(1207);
	exports.SearchField = __webpack_require__(1208);
	exports.DataMixin = __webpack_require__(1209);
	exports.utils = __webpack_require__(1210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Table = __webpack_require__(1205);
	var Pagination = __webpack_require__(1206);
	var SelectField = __webpack_require__(1207);
	var SearchField = __webpack_require__(1208);

	var DataMixin = __webpack_require__(1209);
	...
	var DataTable = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: this.props.className }, React.createElement('div', { className: 'row' }), React.createElement('div', { className: 'table-responsive' }, React.createElement(Table, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sortBy = __webpack_require__(834);
	var some = __webpack_require__(848);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(964)(module), (function() { return this; }())))
