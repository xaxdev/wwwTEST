...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jquery = __webpack_require__(935);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _reduxForm = __webpack_require__(852);

	var _productdetailaction = __webpack_require__(1091);

	var productdetailaction = _interopRequireWildcard(_productdetailaction);

	var _productDescription = __webpack_require__(1093);

	var _productDescription2 = _interopRequireDefault(_productDescription);

	var _productJewalryAttributes = __webpack_require__(1094);

	var _productJewalryAttributes2 = _interopRequireDefault(_productJewalryAttributes);

	var _productStoneAttributes = __webpack_require__(1095);

	var _productStoneAttributes2 = _interopRequireDefault(_productStoneAttributes);

	var _productWatchAttributes = __webpack_require__(1096);

	var _productWatchAttributes2 = _interopRequireDefault(_productWatchAttributes);

	var _productGemstonesAttributes = __webpack_require__(1097);

	var _productGemstonesAttributes2 = _interopRequireDefault(_productGemstonesAttributes);

	var _productGemstonesReleteJewelry = __webpack_require__(1098);

	var _productGemstonesReleteJewelry2 = _interopRequireDefault(_productGemstonesReleteJewelry);

	var _productGallery = __webpack_require__(1099);

	var _productGallery2 = _interopRequireDefault(_productGallery);

	var _productReleted = __webpack_require__(1188);

	var _productReleted2 = _interopRequireDefault(_productReleted);

	var _productPrint = __webpack_require__(1189);

	var _productPrint2 = _interopRequireDefault(_productPrint);

	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../public/css/image-gallery.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../public/css/productdetail.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../../public/css/magnific-popup.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	  ...
	  _createClass(productdetail, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.getProductDetail(productId, productlist).then(function () {
	        _this2.props.getProductRelete(productId, 1);
	      });

	      (0, _jquery2.default)('#zoomimg').magnificPopup({
	        key: 'my-popup',
	        items: {
	          src: (0, _jquery2.default)('<div class="white-popup"><img width="600px" id="galleryimg"/><button id="btnup">Up</button><button id="btndown">Down</button></div>'),
	          type: 'inline'
	        },
	        callbacks: {
	          open: function open() {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.params.id !== this.props.params.id) {
	        (function () {
	          ...
	          var productlist = _this3.props.productlist;
	          _this3.props.getProductDetail(productId, productlist).then(function () {
	            _this3.props.getProductRelete(productId, 1);
	          });
	        })();
	      }
	    }
	    ...
	    value: function renderFooterAttr() {
	      ...
	      if (Detail.type == 'STO') {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_productGemstonesReleteJewelry2.default, { gemstoneAttrData: relatedJewelry })
	        );
	      } else {
	        if (!gemstoneAttr) {
	          return _react2.default.createElement(
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_reactBootstrap.Pagination, {
	            ...
	            onSelect: function onSelect(eventKey) {
	              _this4.props.getProductRelete(productId, eventKey);
	            } }),
	          _react2.default.createElement(
	            'div',
	            null,
	    ...
	    value: function renderNavigation() {
	      ...
	      var _props = this.props;
	      var pagego = _props.fields.pagego;
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', _extends({ type: 'text' }, pagego))
	              )
	            ),
	            _react2.default.createElement(
	              'div',
	    ...
	    value: function handleGo(e) {
	      ...
	      if (getPage <= totalpage && getPage != 0) {
	        this.props.getProductRelete(productId, getPage);
	      }
	    }
	  }, {
	...
	function mapStateToProps(state) {
	  return {
	    ...
	    productlist: state.searchResult.datas
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productdetailconstants = __webpack_require__(1092);
	...
	function getProductDetail(productId, productlist) {
	  return {
	    ...
	    promise: (0, _isomorphicFetch2.default)(_productdetailconstants.ROOT_URL + 'product/' + productId, {
	      method: 'GET'
	    }),
	    productid: productId,
	...
	function getProductRelete(productId, page) {
	  return {
	    type: _productdetailconstants.FETCH_PRODUCTRELETED,
	    promise: (0, _isomorphicFetch2.default)(_productdetailconstants.ROOT_URL + 'productrelete', {
	      method: 'GET'
	    }),
	    page: page
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ROOT_URL = exports.ROOT_URL = '//' + host + ':4500/';
	var FETCH_PRODUCTDETAIL = exports.FETCH_PRODUCTDETAIL = 'FETCH_PRODUCTDETAIL';
	var FETCH_GEMATTRDETAIL = exports.FETCH_GEMATTRDETAIL = 'FETCH_GEMATTRDETAIL';
	var FETCH_PRODUCTRELETED = exports.FETCH_PRODUCTRELETED = 'FETCH_PRODUCTRELETED';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = function Detail(props) {
	  if (logindata) {
	    ...
	    var invoicedDate = new Date(props.createDate);
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          null,
	          currency == 'USD' ? props.actualCostUSD : props.actualCostNonUSD
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'span',
	          null,
	          currency == 'USD' ? props.updatedCostUSD : props.actualCostNonUSD
	        )
	      ),
	      _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactImageGallery = __webpack_require__(1100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assign = __webpack_require__(1101);

	var _assign2 = _interopRequireDefault(_assign);

	var _getPrototypeOf = __webpack_require__(1138);

	var _getPrototypeOf2 = _interopRequireDefault(_getPrototypeOf);

	var _classCallCheck2 = __webpack_require__(1143);
	...
	var _possibleConstructorReturn2 = __webpack_require__(1148);

	var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);

	var _inherits2 = __webpack_require__(1179);
	...
	var _reactSwipeable = __webpack_require__(1187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1106).Object.assign;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1104);

	$export($export.S + $export.F, 'Object', {assign: __webpack_require__(1119)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(1105)
	  , core      = __webpack_require__(1106)
	  , ctx       = __webpack_require__(1107)
	  , hide      = __webpack_require__(1109)
	  , PROTOTYPE = 'prototype';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP         = __webpack_require__(1110)
	  , createDesc = __webpack_require__(1118);
	module.exports = __webpack_require__(1114) ? function(object, key, value){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject       = __webpack_require__(1111)
	  , IE8_DOM_DEFINE = __webpack_require__(1113)
	  , toPrimitive    = __webpack_require__(1117)
	  , dP             = Object.defineProperty;

	exports.f = __webpack_require__(1114) ? Object.defineProperty : function defineProperty(O, P, Attributes){
	  anObject(O);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(1112);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(1114) && !__webpack_require__(1115)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(1115)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(1112)
	  , document = __webpack_require__(1105).document
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys  = __webpack_require__(1120)
	  , gOPS     = __webpack_require__(1135)
	  , pIE      = __webpack_require__(1136)
	  , toObject = __webpack_require__(1137)
	  , IObject  = __webpack_require__(1124)
	  , $assign  = Object.assign;

	// should work with symbols and should have deterministic property order (V8 bug)
	module.exports = !$assign || __webpack_require__(1115)(function(){
	  var A = {}
	    , B = {}
	    , S = Symbol()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $keys       = __webpack_require__(1121)
	  , enumBugKeys = __webpack_require__(1134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has          = __webpack_require__(1122)
	  , toIObject    = __webpack_require__(1123)
	  , arrayIndexOf = __webpack_require__(1127)(false)
	  , IE_PROTO     = __webpack_require__(1131)('IE_PROTO');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IObject = __webpack_require__(1124)
	  , defined = __webpack_require__(1126);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(1125);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// false -> Array#indexOf
	// true  -> Array#includes
	var toIObject = __webpack_require__(1123)
	  , toLength  = __webpack_require__(1128)
	  , toIndex   = __webpack_require__(1130);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 7.1.15 ToLength
	var toInteger = __webpack_require__(1129)
	  , min       = Math.min;
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shared = __webpack_require__(1132)('keys')
	  , uid    = __webpack_require__(1133);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defined = __webpack_require__(1126);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1106).Object.getPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toObject        = __webpack_require__(1137)
	  , $getPrototypeOf = __webpack_require__(1141);

	__webpack_require__(1142)('getPrototypeOf', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1104)
	  , core    = __webpack_require__(1106)
	  , fails   = __webpack_require__(1115);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty = __webpack_require__(1145);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $Object = __webpack_require__(1106).Object;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(1114), 'Object', {defineProperty: __webpack_require__(1110).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof2 = __webpack_require__(1149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iterator = __webpack_require__(1150);

	var _iterator2 = _interopRequireDefault(_iterator);

	var _symbol = __webpack_require__(1168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(1151), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1163)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $at  = __webpack_require__(1153)(true);

	// 21.1.3.27 String.prototype[@@iterator]()
	__webpack_require__(1154)(String, 'String', function(iterated){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var LIBRARY        = __webpack_require__(1155)
	  , $export        = __webpack_require__(1104)
	  , redefine       = __webpack_require__(1156)
	  , hide           = __webpack_require__(1109)
	  , has            = __webpack_require__(1122)
	  , Iterators      = __webpack_require__(1157)
	  , $iterCreate    = __webpack_require__(1158)
	  , setToStringTag = __webpack_require__(1162)
	  , getPrototypeOf = __webpack_require__(1141)
	  , ITERATOR       = __webpack_require__(1163)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var create         = __webpack_require__(1159)
	  , descriptor     = __webpack_require__(1118)
	  , setToStringTag = __webpack_require__(1162)
	  , IteratorPrototype = {};

	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(1109)(IteratorPrototype, __webpack_require__(1163)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createDict = function(){
	  ...
	  __webpack_require__(1161).appendChild(iframe);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP       = __webpack_require__(1110)
	  , anObject = __webpack_require__(1111)
	  , getKeys  = __webpack_require__(1120);

	module.exports = __webpack_require__(1114) ? Object.defineProperties : function defineProperties(O, Properties){
	  anObject(O);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1105).document && document.documentElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(1110).f
	  , has = __webpack_require__(1122)
	  , TAG = __webpack_require__(1163)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store      = __webpack_require__(1132)('wks')
	  , uid        = __webpack_require__(1133)
	  , Symbol     = __webpack_require__(1105).Symbol
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(1105)
	  , hide          = __webpack_require__(1109)
	  , Iterators     = __webpack_require__(1157)
	  , TO_STRING_TAG = __webpack_require__(1163)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var addToUnscopables = __webpack_require__(1166)
	  , step             = __webpack_require__(1167)
	  , Iterators        = __webpack_require__(1157)
	  , toIObject        = __webpack_require__(1123);
	...
	module.exports = __webpack_require__(1154)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1106).Symbol;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(1105)
	  , core           = __webpack_require__(1106)
	  , has            = __webpack_require__(1122)
	  , DESCRIPTORS    = __webpack_require__(1114)
	  , $export        = __webpack_require__(1104)
	  , redefine       = __webpack_require__(1156)
	  , META           = __webpack_require__(1171).KEY
	  , $fails         = __webpack_require__(1115)
	  , shared         = __webpack_require__(1132)
	  , setToStringTag = __webpack_require__(1162)
	  , uid            = __webpack_require__(1133)
	  , wks            = __webpack_require__(1163)
	  , keyOf          = __webpack_require__(1172)
	  , enumKeys       = __webpack_require__(1173)
	  , isArray        = __webpack_require__(1174)
	  , anObject       = __webpack_require__(1111)
	  , toIObject      = __webpack_require__(1123)
	  , toPrimitive    = __webpack_require__(1117)
	  , createDesc     = __webpack_require__(1118)
	  , _create        = __webpack_require__(1159)
	  , gOPNExt        = __webpack_require__(1175)
	  , $GOPD          = __webpack_require__(1177)
	  , $DP            = __webpack_require__(1110)
	  , gOPD           = $GOPD.f
	  , dP             = $DP.f
	  , gOPN           = gOPNExt.f
	...
	if(!USE_NATIVE){
	  ...
	  $DP.f   = $defineProperty;
	  __webpack_require__(1176).f = gOPNExt.f = $getOwnPropertyNames;
	  __webpack_require__(1136).f  = $propertyIsEnumerable
	  __webpack_require__(1135).f = $getOwnPropertySymbols;

	  if(DESCRIPTORS && !__webpack_require__(1155)){
	...
	$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(1109)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var META     = __webpack_require__(1133)('meta')
	  , isObject = __webpack_require__(1112)
	  , has      = __webpack_require__(1122)
	  , setDesc  = __webpack_require__(1110).f
	  , id       = 0;
	var isExtensible = Object.isExtensible || function(){
	  return true;
	};
	var FREEZE = !__webpack_require__(1115)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(1123)
	  , gOPN      = __webpack_require__(1176).f
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $keys      = __webpack_require__(1121)
	  , hiddenKeys = __webpack_require__(1134).concat('length', 'prototype');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pIE            = __webpack_require__(1136)
	  , createDesc     = __webpack_require__(1118)
	  , toIObject      = __webpack_require__(1123)
	  , toPrimitive    = __webpack_require__(1117)
	  , has            = __webpack_require__(1122)
	...
	exports.f = __webpack_require__(1114) ? gOPD : function getOwnPropertyDescriptor(O, P){
	  O = toIObject(O);
	  P = toPrimitive(P, true);
	  if(IE8_DOM_DEFINE)try {
	    return gOPD(O, P);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setPrototypeOf = __webpack_require__(1180);

	var _setPrototypeOf2 = _interopRequireDefault(_setPrototypeOf);

	var _create = __webpack_require__(1184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(1181), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(1106).Object.setPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1104);
	$export($export.S, 'Object', {setPrototypeOf: __webpack_require__(1183).set});
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(1107)(Function.call, __webpack_require__(1177).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(1104)
	// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
	$export($export.S, 'Object', {create: __webpack_require__(1159)});
	...
	var productreleted = function productreleted(props) {
	  return _react2.default.createElement(
	    ...
	    props.productrelte.map(function (data, index) {
	      return _react2.default.createElement(
	        'div',
	        { key: data.id, className: 'col-md-3' },
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: { pathname: '' + pructdetailurl + data.id } },
	          _react2.default.createElement('img', { src: data.image, responsive: true, width: 200, height: 200 })
	        )
	      );
	    })
	  );
