export default function GenTemplateHtml(ROOT_URL, imagesReplace, dv){
    ...
    let styleSearchproductGride  ='width: 155px; margin: 0 auto; text-align: center;font-size: 10px;position: relative;z-index: 2;padding: 15px 11px 0 11px;height: 380px;cursor: pointer;';
    let colmd3colsm3nopadding  = 'width: 180px; padding: 0;float: left;height: 380px; margin: 0 auto;';
    ...
    let thumbnaillgrid = 'margin: 0 auto; height: 200px; overflow: hidden; position: relative; width:155px;';
