    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('select',
                  { valueselect: this.props.value, onChange: this.onChangeSelect },
                  _react2['default'].createElement('option', { value: '' }, '-All-'),
                  _react2['default'].createElement('option', { value: 'true' }, 'Active'),
                  _react2['default'].createElement('option', { value: 'false' }, 'Inactive')
      )
      );
    }
  }]);
