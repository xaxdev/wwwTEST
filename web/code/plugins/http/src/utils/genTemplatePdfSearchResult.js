...
export default function GenTemplateHtml(showGridView, showListView, ROOT_URL, imagesReplace, dv){
    ...
    dvListview = dvListview.replace(/class="table table-bordered table-searchresult"/g,'style="font-size: 8px; border-spacing: 0;margin:0 auto; width:790px;"');
    ...
    dvListviewAll = dvListviewAll.replace(/class="table table-bordered table-searchresult"/g,'style="font-size: 8px; border-spacing: 0; margin:0 auto; width:790px;"');
