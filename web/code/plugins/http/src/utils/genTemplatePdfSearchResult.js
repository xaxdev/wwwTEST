...
=======
    dvListview = dvListview.replace(/class="table table-bordered table-searchresult"/g,'border="1" style="font-size: 8px; border-spacing: 0;margin:0 auto;" width="100%"');
>>>>>>> fix css table search result
