...
export default function GenTemplateHtml(showGridView, showListView, ROOT_URL, imagesReplace, dv){
    ...
    dvListviewAll = dvListviewAll.replace(/<th role="columnheader" scope="col"/g,'<th style="padding:10px 10px; text-align:center; color:#fff; background-color: #383735;  font-weight: normal; font-size: 7px; border: 1px solid #5c5954;" role="columnheader" scope="col"');
    ...
    dvListviewAll = dvListviewAll.replace(/class="tdd"/g,'style="padding:5px 5px;word-break: normal;font-size: 7px; border: 1px solid #5c5954;"');
    dvListviewAll = dvListviewAll.replace(/class="bd-lb-white"/g,'style="border-left: 1px solid #fff;border-bottom: 1px solid #fff;padding:5px 5px;word-break: normal;font-size: 7px;"');
