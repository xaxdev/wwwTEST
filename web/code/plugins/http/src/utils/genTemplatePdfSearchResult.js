...
export default function GenTemplateHtml(showGridView, showListView, ROOT_URL, imagesReplace, dv){
    ...
    dvListview = dvListview.replace(/class="font-b fc-000 text-center bg-eb"/g,`style="font-weight: bold; font-family:'${'open_sanssemibold'}';color:#000;text-align: center;background-color: #ebd79a;padding:5px 5px;word-break: normal;font-size: 7px; border: 1px solid #5c5954;border-right: transparent; border-bottom: 1px solid #5c5954;"`);
    dvListview = dvListview.replace(/class="font-b fc-000 text-right bg-eb"/g,`style="text-align:right;font-weight: bold; font-family:'${'open_sanssemibold'}';color:#000;background-color: #ebd79a;padding:5px 5px;word-break: normal;font-size: 7px;border: 1px solid #5c5954; border-right: transparent; border-bottom: 1px solid #5c5954;"`);
    ...
    dvListviewAll = dvListviewAll.replace(/class="font-b fc-000 text-center bg-eb"/g,`style="font-weight: bold; font-family:'${'open_sanssemibold'}';color:#000;text-align: center;background-color: #ebd79a;padding:5px 5px;word-break: normal;font-size: 7px; border: 1px solid #5c5954;border-right: transparent; border-bottom: 1px solid #5c5954;"`);
    dvListviewAll = dvListviewAll.replace(/class="font-b text-right fc-000 bg-eb"/g,`style="text-align:right;font-weight: bold; font-family:'${'open_sanssemibold'}';color:#000;background-color: #ebd79a;padding:5px 5px;word-break: normal;font-size: 7px; border: 1px solid #5c5954; border-right: transparent; border-bottom: 1px solid #5c5954;"`);
