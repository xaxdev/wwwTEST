export default function GenTemplateHtml(showGridView, showListView, ROOT_URL, imagesReplace, dv){
    ...
    let colmd3colsm3nopadding  = 'width: 13.8%; padding: 0;float: left;height: 380px; margin: 0 auto;';
    ...
    let thumbnaillgrid = 'margin: 0 auto; height: 200px; overflow: hidden; position: relative; width:180px; display: table;';
