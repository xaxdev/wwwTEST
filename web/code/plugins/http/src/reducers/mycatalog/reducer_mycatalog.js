import  {
    GET_CATALOGITEMS, DELETE_ITEMSFROMCATALOG, SET_SLECTEDCATALOG, SET_NEWCATALOGNAME, DELETE_CATALOG, GET_CATALOGNAME, SET_CATALOGSORTBY, 
    SET_CATALOGSORTDIRECTION, SET_CATALOGCURRENTPAGE, SET_RENAMECATALOG, SET_SHARECATALOG, SET_CLOSEALERTMSG, SET_ISCATALOGSHARED, GET_SETCATALOGNAME, 
    ...
    SET_SETCATALOGSORTDIRECTION, DELETE_ITEMSFROMSETCATALOG, SET_LISTCATALOGITEMS, SET_LISTSETCATALOGITEMS
...
export default function(state = INITIAL_STATE, action){
    switch(action.type){
        case SET_LISTSETCATALOGITEMS:
            return {...state, listSetCatalogItems: action.listSetCatalogItems };
        case SET_LISTCATALOGITEMS:
            return {...state, listCatalogItems: action.listCatalogItems };
