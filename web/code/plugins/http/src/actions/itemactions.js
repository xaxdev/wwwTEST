...
import {
    ...
    FIRSTSEARCH, SET_TITLECOLUMN, SAVE_TITLECOLUMN, FETCH_TITLECOLUMN, SET_LISTCATALOGITEMS, SET_LISTSETCATALOGITEMS
...
export function setListCatalogItems(value){
    return {
        type: SET_LISTCATALOGITEMS,
        listCatalogItems: value
    }
}

export function setListSetCatalogItems(value){
    return {
        type: SET_LISTSETCATALOGITEMS,
        listSetCatalogItems: value
    }
}