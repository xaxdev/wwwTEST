...
import {
    ...
    GET_SETCATALOGITEMSLIST, FETCH_SETCATALOGDETAILS, FETCH_SALESPRODUCTDETAIL, FETCH_SALESPRODUCTRELETED
...
export function getSalesProductRelete(collection,page,productId,dominant,currency,price){
    ...
    return {
        ...
        promise: fetch( `${ROOT_URL}api/items/relatedsalesitems/${collection}/${page}/${productId}/${dominant}/${currency}/${price}`,{
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
                'Authorization': token
