                        ...
                        <div className="col-md-12 maring-b10 nopadding">
                            <div className="col-sm-5 col-xs-5 nopadding">
                                ...
                                <div className="col-sm-8 col-xs-8 nopadding">
                                    <div className="radio">
                                        <input type="radio" {...printPage} value="all" checked={printPage.value === 'all'} />
                                        <label className="select"></label>
                                        <span className="margin-l10 text-vertical">All</span>
                                    </div>
                                    <div className="radio">
                                        <input type="radio" {...printPage} value="current" checked={printPage.value === 'current'} />
                                        <label className="select"></label>
                            ...
                            <div className="col-sm-6 col-xs-6 nopadding">
                                ...
                                <div className="col-sm-10 col-xs-10">
                                    <div className="radio">
                                        <input type="radio" {...printPrice} value="all" checked={printPrice.value === 'all'} />
                                        <label className="select"></label>
                                        <span className="margin-l10 text-vertical">All</span>
                                    </div>
                                    <div className="radio">
