...
class SearchResult extends Component {
  ...
  renderTotals(){
    ...
    return(
      <div>
          <span><span className="font-b fc-000">Total Items :</span> <span className="font-w9">{ allItems.length.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,') }</span><span className="padding-lf15">|</span></span>
