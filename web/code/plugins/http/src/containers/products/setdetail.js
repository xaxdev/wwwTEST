                ...
                <div className="bar-title-detail maring-t15">
                    ...
                    <div className="display-right">
                        <div className={`float-l bar-detail-pre ${productIndex == 0?'hidden':''}`}>
                            <Link className={productIndex == 0?'disabled-link':''} to={{pathname: productIndex != 0 ?`${pructdetailurl}${(productlist[productIndex-1].reference != undefined)? productlist[productIndex-1].reference.replace('/','-'):''}`:''}}>
