...
class Loginform extends Component {
    ...
    render() {
        const { fields: { username, password }, handleSubmit, invalid } = this.props;

        return (
            <form onSubmit={handleSubmit} className="focused">
