  ...
  return (
        <div>
            <div className="searchresult-navi search-right">
                <div>
                    <Pagination prev next first last ellipsis boundaryLinks items={props.totalpage} maxButtons={4} activePage={activePage}
            ...
            <DataTable className="col-sm-12"
                keys={['stoneTypeName','cutName', 'colorName', 'clarityName', 'lotNumber', 'lotQty', 'carat',
                'certificateNo', 'laboratory','certifiiedDate','origin', 'symmetry','fluorescence' ]}
                columns={tableColumns} initialData={lots} initialPageLength={props.pageSize}
