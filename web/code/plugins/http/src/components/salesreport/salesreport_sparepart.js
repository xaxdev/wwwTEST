...
class SalesReportSparePart extends Component {
    ...
    handleArticleSelectedChanged = (ArticleSelectedValue) => {
        ...
        let { fields: {
            article, sparePartType, buckleType, metalType, metalColour, dominantStone, sparePartProductSalesHierarchy
        }, searchResult } = props;
        let findFieldName = [];
        ...
        if (ArticleSelectedValue == '') {
            let salesHierarchyData = RemoveSalesHierarchy(notUseSalesHierarchy, hiTreeData, 'SPP');
