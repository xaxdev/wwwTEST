...
class GridSalesItemsView extends Component {
    constructor(props) {
        ...
        this.onClickGridSales = this.onClickGridSales.bind(this);
    ...
    onClickGridSales(event) {
        event.preventDefault();
        this.props.onClickGrid(event.currentTarget.id);
    }

    onMouseOverGrid(e){
        OnMouseOverGrid(this, e.currentTarget.id, oldView);
    }

    onMouseOutGrid(e){
        OnMouseOutGrid(this, e.currentTarget.id);
    }
    renderShowDetails(){
        return(
    ...
    render(){
        ...
        const btnEvent = this.onClickGridSales;
