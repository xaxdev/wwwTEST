...
class RenderViewSalesProductGroup extends Component {
    ...
    render(){
        ...
        const { fields: {
            ...
            productGroupSalesSPA, productGroupSalesErr, bomSales
        }, userTypeValue } = props;

        return(
            <div className={`${userTypeValue != 'OnHand' && userTypeValue != null ?'':'hidden'}`}>
                ...
                <div className="form-group">
                    <label className="col-sm-2 control-label">View BOM Sales</label>
                    <div className="col-sm-7">
                        <input type="checkbox" {...bomSales}/>
                    </div>
                </div>
            </div>
        )
