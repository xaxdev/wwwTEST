                    ...
                    this.props.items.map(function(item, index){
                        ...
                        return (
                            <div key={item.id != null ? `id=${item.id}` : `reference=${item.reference}`}
                                ...
                                <div>
                                    <div key={item.id != null ? `id=${item.id}` : `reference=${item.reference}`} id={index} ref={'div'+index}
                                        style={{
                                        display:(index==0)?`${that.state.isOpen0 ? '' : 'none'}`:
                                           ...
                                           ||index==35||index==39||index==43||index==47||index==51||index==55||index==59)?
                                           'over-searchresult-left':'over-searchresult' }>
